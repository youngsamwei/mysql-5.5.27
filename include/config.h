...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql55"
#define SHAREDIR "/usr/local/mysql55/share"
#define DEFAULT_BASEDIR "/usr/local/mysql55"
#define MYSQL_DATADIR "/usr/local/mysql55/data"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql55"
#define PLUGINDIR "/usr/local/mysql55/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/mysql55/etc"
